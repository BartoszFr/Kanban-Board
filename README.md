...
Aplikacja wymaga korekt w zakresie pisowni znaków polskich oraz eksportu do pliku dat przeniesienia zadań do kolumny `Done`. Również uwzględnianie lat przestępnych wymaga poprawy. Perspektywą dalszego rozwoju aplikacji jest dodanie interfejsu graficznego.
